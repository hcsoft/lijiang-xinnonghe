						...
						if(row && selectindex != undefined){
							$.messager.confirm('提示框', '你确定要删除吗?',function(r){
								if(r){
									$.ajax({
										type: "post",
										url: "<%=request.getContextPath()%>/Userinfo/deleteuser.do",
						...
						data-options="iconCls:'icon-edit',singleSelect:true,idField:'itemid'" rownumbers="true"> 
							<thead>
								<tr>
									...
									<th data-options="field:'user_id',width:80,align:'left',editor:{type:'validatebox'}">医疗机构编码</th>
									<th data-options="field:'user_name',width:200,align:'left',editor:{type:'validatebox'}">医疗机构名称</th>
