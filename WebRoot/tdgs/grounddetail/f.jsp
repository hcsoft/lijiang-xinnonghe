								...
								if(row.status=='01'){
									...
									$('#fcczfxxgrid').datagrid({
										...
										columns:[[
											...
											{field:'agreementnumber',title:'承租方文书号或协议号',width:140,align:'center',editor:{type:'validatebox',options:{required:true}}},   
											{field:'lesseesid',width:130,align:'center',hidden:true,editor:{type:'numberbox'}},  
											{field:'lesseestaxpayername',title:'承租方名称(回车查询)',width:140,align:'center',editor:{required:true,type:'validatebox'}},
											...
											{field:'landarea',title:'承租面积',width:70,align:'center',editor:{type:'numberbox',options:{precision:2,min:0,required:true}}},
											...
											{field:'transbegindates',title:'承租时间起',width:80,align:'center',editor:{type:'datebox',options:{validType:['datecheck'],required:true}}},
											{field:'transenddates',title:'承租时间止',width:80,align:'center',editor:{type:'datebox',options:{validType:['datecheck'],required:true}}}
											]],
										toolbar:[{
											text:'新建',
											id:'f2-add',
...
$.extend($.fn.validatebox.defaults.rules, {   
			...
			data-options="singleSelect:true,idField:'itemid'" rownumbers="true"> 
				<thead>
					<tr>
						...
						<th data-options="field:'housesource',width:80,align:'center',formatter:formatsource,editor:{type:'combobox',options:{valueField:'key',required:true,editable:false,textField: 'value',	data:housesourcedata}}">房产来源</th>
		...
		<div id="fcczfxxwindow" class="easyui-window" data-options="closed:true,modal:true,title:'房产承租方信息',collapsible:false,minimizable:false,maximizable:false,closable:false" style="width:1050px;height:400px;">
