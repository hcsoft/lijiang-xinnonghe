...
<head>
	...
	$(function(){
	    ...
	    function getWhereCondition(params){
	    	...
	    	params.taxtypecode = gloabTypeCode;
		...
		function exit(){
			...
			var currentUrl = "/tdgs/shouldtaxgather/taxtypeshouldtaxgatherpage.jsp";
...
<body>
     <div class="easyui-layout" style="width:100%;height:550px;" data-options="split:true" id="layoutDiv" >
	     <div data-options="region:'center'">
			...
			<table id='groundstoragegrid' class="easyui-datagrid" style="width:1130px;height:519px;overflow: scroll;"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'alreadyShouldTaxMoney',width:120,align:'center',editor:{type:'validatebox'}">实缴金额</th>
		...
		<div data-options="region:'north'" style="height:25px;width:100%;overflow: visible" >
			<div style="height:25px;">
				...
				<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-export',plain:true" onclick="exportMainExcel()" style="display:none;">导出EXCEL</a>
	...
	minimizable:false,maximizable:false,closable:true" style="width:640px;height:205px;">
