...
<head>
	...
	<script src="avoidtaxgather.js"></script>		
...
<body>
     <div class="easyui-layout" style="width:100%;height:550px;" data-options="split:true" id="layoutDiv" >
	     <div data-options="region:'center'">
			...
			<table id='groundstoragegrid' class="easyui-datagrid" style="width:99;height:520px;overflow: scroll;"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'shouldTaxMoney',hidden:true,width:120,align:'center',editor:{type:'validatebox'}">应缴金额</th>
						<th data-options="field:'alreadyShouldTaxMoney',hidden:true,width:120,align:'center',editor:{type:'validatebox'}">实缴金额</th>
						<th data-options="field:'avoidtaxmoney',width:120,align:'center',editor:{type:'validatebox'}">减免金额</th>
						<th data-options="field:'owetaxmoney',hidden:true,width:120,align:'center',editor:{type:'validatebox'}">欠税金额</th>
					</tr>
				</thead>
			</table>
		    </form>
				...
				<table id="narjcxx" width="100%"  cellpadding="3" cellspacing="0" border="1" bordercolor="#FCD209" style="border-collapse:collapse">
					...
					<tr>
						...
						至
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							是否欠税：<input type="checkbox" id="ownstaus" name="ownstaus"/>
						</td>
					</tr>
				</table>
			</form>
			...
			data-options="iconCls:'icon-edit',singleSelect:true,idField:'taxpayerid',pageList:[10],nowrap:true">
				<thead>
					<tr>
						...
						<th data-options="field:'shouldtaxmoney',width:120,align:'left',editor:{type:'validatebox'}">应缴金额</th>
						<th data-options="field:'alreadyshouldtaxmoney',width:120,align:'left',editor:{type:'validatebox'}">已缴金额</th>
						<th data-options="field:'owetaxmoney',width:120,align:'left',editor:{type:'validatebox'}">欠税金额</th>
