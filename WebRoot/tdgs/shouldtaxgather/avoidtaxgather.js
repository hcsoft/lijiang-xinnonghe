...
var ShouldTaxUtils = (function(){
			...
			var taxtypenameCol = {'field':'taxtypename','width':160,'hidden':false,'align':'center','editor':{'type':'validatebox'},'title':'税种'};
            ...
            var taxdeptcodeCol = {'field':'taxdeptcode','width':100,'hidden':true,'align':'center','editor':{'type':'validatebox'},'title':'主管税务机关代码','orgcol':'taxdeptname'};
			...
			var shouldtaxmoneyCol = {'field':'shouldtaxmoney','width':100,'hidden':true,'align':'center','editor':{'type':'validatebox'},'title':'应缴金额'};
			var avoidtaxmoneyCol = {'field':'avoidtaxmoney','width':100,'hidden':false,'align':'center','editor':{'type':'validatebox'},'title':'减免金额'};
			var owetaxmoneyCol = {'field':'owetaxmoney','hidden':true,'width':100,'align':'center','editor':{'type':'validatebox'},'title':'欠税金额'};
			var alreadyshouldtaxmoneyCol = {'field':'alreadyshouldtaxmoney','hidden':true,'width':100,'align':'center','editor':{'type':'validatebox'},'title':'实缴金额'};
			var stayinspecttaxmoneyCol = {'field':'stayinspecttaxmoney','hidden':true,'width':100,'align':'center','editor':{'type':'validatebox'},'title':'待核查'};
            var viewDetailCol = {'field':'viewdetail','hidden':true,'width':120,'align':'center','formatter':addViewDetailButton,'title':'操作'};
