...
//		LODOP.SET_SAVE_MODE("QUICK_SAVE",true);//快速生成（无表格样式,数据量较大时或许用到） 
	...
	function prn1_printA() {		
		...
		$.ajax({
		   type: "post",
		   url: "/GroundCheckServlet/printUpdate.do?"+url.substring(url.indexOf("?")+1,url.length),
	...
	$(function(){
		...
		//alert(url.substring(url.indexOf("?")+1,url.length));
		 /**/ $.ajax({
			type: 'POST',
	        url: "/GroundCheckServlet/print.do?"+url.substring(url.indexOf("?")+1,url.length),
          ...
          <tr>
            ...
            <div align="center" > <!-- id="content2" -->
                ...
                <table   width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
                  <tr > 
                    <td height="60" colspan="2" width="89" valign="middle"  align="center"><font size="2">计算机编码</font></td>
                    <td height="60" colspan="1" width="149" valign="middle"  align="center"><font id="taxpayerid" size="2"></font></td>
                    <td height="60" colspan="2" width="139" valign="middle"  align="center"><font size="2">纳税人名称</font></td>
                    <td height="60" colspan="3" width="266" valign="middle"  align="center"><font id="taxpayername" size="2"></font></td>
                    <td height="60" colspan="1" width="85" valign="middle"  align="center"><font size="2">注册类型</font></td>
                    <td height="60" colspan="2" width="192" valign="middle"  align="center"><font id="econaturecode" size="2"></font></td>
                    <!--  -->
                    <td height="60" colspan="1" width="26" rowspan="2" valign="middle" align="center"><font size="2">二<br>维<br>码</font></td>
                    <td height="60" colspan="2" width="153" rowspan="2" valign="middle"  align="center"><font size="2"></font></td>
                    
                  </tr>
                  <tr >
                    <td height="60" colspan="2" width="89" valign="middle"  align="center"><font size="2">所属行业</font></td>
                    <td height="60" colspan="1" width="149" valign="middle"  align="center"><font id="callingcode" size="2"></font></td>
                    <td height="60" colspan="2" width="139" valign="middle"  align="center"><font size="2">联系人</font></td>
                    <td height="60" colspan="3" width="266" valign="middle"  align="center"><font id="taxcontactperson" size="2"></font></td>
                    <td height="60" colspan="1" width="85" valign="middle"  align="center"><font size="2">联系电话</font></td>
                    <td height="60" colspan="2" width="192" valign="middle"  align="center"><font id="taxcontactpersontel" size="2"></font></td>
                  </tr>
				</table>
