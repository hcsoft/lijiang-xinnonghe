	...
	var menu21 = [{
					...
					handler:function(){
						...
						if(row){
							...
							$.messager.alert('返回消息',"请选择需要转让的土地！");
						}
					}
				}];
		var menu22 = [{
...
<body>
	...
	<div id="groundcheckquerywindow" class="easyui-window" data-options="closed:true,modal:true,title:'土地转让查询',collapsible:false,minimizable:false,maximizable:false,closable:true" style="width:940px;height:300px;">
		<div class="easyui-panel" title="" style="width:900px;">
	...
	<div id="groundassignmentwindow" class="easyui-window" data-options="closed:true,modal:true,title:'土地基础信息',collapsible:false,minimizable:false,maximizable:false,closable:true" style="width:960px;height:500px;">
		<div title="批复信息" data-options="
					tools:[{
						handler:function(){
	...
	<div id="groundbusinesswindow" class="easyui-window" data-options="closed:true,modal:true,title:'土地转让',collapsible:false,minimizable:false,maximizable:false,closable:true,resizable:false" style="width:960px;height:500px;">
	</div>
</body>
</html>