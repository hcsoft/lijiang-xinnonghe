...
<body>
	<form id="paidintaxqueryform" method="post">
		<div title="未纳入管理纳税人查询" data-options="
						tools:[{
							handler:function(){
						...
						data-options="iconCls:'icon-edit',singleSelect:true,idField:'itemid'" rownumbers="true"> 
							<thead>
								<tr>
									...
									<th data-options="field:'housetax',width:80,align:'center',editor:{type:'validatebox'}">税种</th>
									<th data-options="field:'constructiontax',width:60,align:'center',editor:{type:'validatebox'}">税目</th>
									<th data-options="field:'educationtax',width:60,align:'center',editor:{type:'validatebox'}">税款所属期起</th>
									<th data-options="field:'localeducationtax',width:60,align:'center',editor:{type:'validatebox'}">税款所属期止</th>
									<th data-options="field:'stamptax',width:60,align:'center',editor:{type:'validatebox'}">税款金额</th>
	...
	<div id="paidintaxqueryquerywindow" class="easyui-window" data-options="closed:true,modal:true,title:'未纳入管理纳税人清册',collapsible:false,minimizable:false,maximizable:false,closable:true" style="width:940px;height:300px;">
					...
					<tr>
						...
						<td>
							<select id="taxclasscode" class="easyui-combobox" name="taxclasscode" style="width:200px"  editable="false">
								<option value=""></option>
								<option value="0">土地使用税</option>
								<option value="1">房产税</option>
