...
//		alert(url.substring(url.indexOf("?")+1,url.length));
		 /**/ $.ajax({
			type: 'POST',
	        url: "/GroundGatherCheckServlet/print.do?"+url.substring(url.indexOf("?")+1,url.length),
        ...
        <table  border="0" >
          <tr>
            ...
            <div align="center" > <!-- id="content2" -->
				...
				<table  width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
                   <tr>
                  	<td height="21" colspan="8" width="532" valign="top"  align="left">
                  		<font size="2">纳税人声明：此核实表所填列的土地、房产信息，是真实、完整的，如有虚假，愿承担相应的法律责任。
                  		<br><br>
                  		法定代表人（签字）：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp; 月 &nbsp;&nbsp; 日
                  		<br>
                    ...
                    <td height="21" colspan="3" width="296" valign="top"  align="left"><font size="2">主管税务机关的核实意见：
                    	<br><br><br>
                    	税收管员：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分局负责人：
                    	<br>
