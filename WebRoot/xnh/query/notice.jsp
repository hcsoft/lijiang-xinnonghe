...
<head>
	...
	function endEditing(){  
		...
		function query(){
			...
			opts.url = '<%=request.getContextPath()%>/Manager/getusernoticelist.do';
						...
						data-options="iconCls:'icon-edit',singleSelect:true,idField:'itemid'" rownumbers="true"> 
							<thead>
								<tr>
									...
									<th data-options="field:'readflag',width:100,align:'center',formatter:formatreadflag,editor:{type:'validatebox'}">已读标识</th>
								</tr>
							</thead>
						</table>
