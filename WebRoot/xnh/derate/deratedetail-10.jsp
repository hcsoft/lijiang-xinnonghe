				...
				toolbar:[{
					...
					handler:function(){
						if(endEditing()){
							...
							var optorg = $('#deratedetailgrid').datagrid('getEditor', {index:index,field:'opt_orgcode'});
							var $optorg = optorg.target;
							$optorg.prop('readonly',true); 
							editIndex = index;
						}
						...
						data-options="iconCls:'icon-edit',singleSelect:true" rownumbers="true"> 
							<thead>
								<tr>
									...
									<th data-options="field:'opt_empcode',width:120,align:'center',hidden:'true'"></th>
									...
									<!-- <th data-options="field:'doctor',width:120,align:'center',formatter:formatemp,editor:{type:'combobox',options:{valueField: 'key',
									textField: 'value',data :doctordata,panelHeight: 'auto'required:false}}">医生</th> -->
									<th data-options="field:'doctor',width:100,align:'center',formatter:formatemp,editor:{type:'combobox',options:{
									valueField: 'key',
									textField: 'value',
									data :doctordata,
									panelHeight: 'auto'}}">医生</th>
