...
t.find(".l-btn-text").html("<span>&nbsp;</span>");
if(_71.iconCls){
...
a.wrap("<td></td>");
a.linkbutton({iconCls:btn.iconCls,plain:true,text:btn.text}).unbind(".pagination").bind("click.pagination",function(){
...
_9d.bb.refresh.linkbutton({iconCls:(_9e.loading?"pagination-loading":"")});
}
};
...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying {from} to {to} of {total} items",nav:{first:{iconCls:"",text:"首页",handler:function(){
var _ad=$(this).pagination("options");
if(_ad.pageNumber>1){
$(this).pagination("select",1);
}
}},prev:{iconCls:"",text:"上一页",handler:function(){
var _ae=$(this).pagination("options");
if(_ae.pageNumber>1){
$(this).pagination("select",_ae.pageNumber-1);
}
}},next:{iconCls:"",text:"下一页",handler:function(){
