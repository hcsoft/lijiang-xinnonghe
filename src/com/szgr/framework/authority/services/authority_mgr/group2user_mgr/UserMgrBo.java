...
public class UserMgrBo {
	...
	public String getTaxorgshortname() {
		return taxorgshortname;
	}

	public void setTaxorgshortname(String taxorgshortname) {
		this.taxorgshortname = taxorgshortname;
	}
